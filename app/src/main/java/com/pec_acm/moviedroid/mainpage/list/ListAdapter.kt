...
class ListAdapter(val context : Context,val listViewModel: ListViewModel,val fragment: Fragment?): RecyclerView.Adapter<ListAdapter.ListViewHolder>() {
    ...
    inner class ListViewHolder(itemView: View, var itemID: Int? = null) :
